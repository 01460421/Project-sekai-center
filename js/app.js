class Component extends DCLogic {
  ...
  loadBilling() {
    ...
    return (this._billP = new Promise(res => {
      ...
      s.src = 'data/billing.js?v=0e6f0e9486';
  ...
  async loadAi() {
    if (!this._aiReady) {
      this._aiReady = import('./js/ai.min.js?v=233b293ec9').then(m => { Object.assign(this, m.aiMembers.call(this)); this.setState({ aiReady: true }); return true; })
