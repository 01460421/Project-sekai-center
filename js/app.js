class Component extends DCLogic {
  ...
  BOT_FEATURES = [
    ...
    { t: 'QQ 小號', d: '一般 QQ 帳號進群當第二隻機器人：不用 @，裸打 h20-24 就報班；提醒真的 @ 到 QQ 號；橋接房號同步改群名。跟官方機器人共用同一份名冊與班表，任何人 @ 官方機器人一次就自動對上。', isNew: true },
  ...
  BOT_SIDES = [
    ...
    { n: 'QQ 群', s: '官方機器人要 @，小號免 @；指令用簡體', c: '#12a9c2', rows: [
      ...
      { c: '/排名 100', d: '查名次與分數' }, { c: '/报跑 20-24 小明', d: '管理員報跑順便指定跑者' }, { c: '/r 20-24', d: '跑者自己報跑（要管理員先開放）' }, { c: 'h20-24', d: '群裡有小號時裸打也收，不用 @' }] },
