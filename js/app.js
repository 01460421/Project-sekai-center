class Component extends DCLogic {
  ...
  ensureEngine() {
    ...
    this._engP = new Promise((res, rej) => {
      ...
      el.src = './js/core.js?v=634f86c08d';
      el.onload = res;
  ...
  loadBilling() {
    ...
    return (this._billP = new Promise(res => {
      ...
      s.src = 'data/billing.js?v=dc4c64ec71';
    ...
    switch (name) {
      ...
      case 'shop_recommend': {
        ...
        if (typeof BILLING_DATA === 'undefined') {
          await new Promise(res => {
            const s = document.createElement('script');
            s.src = 'data/billing.js?v=dc4c64ec71';   // CI 每 30~90 分鐘重建,vercel.json 已設 must-revalidate,不帶版本參數
