class Component extends DCLogic {
  ...
  loadBilling() {
    ...
    return (this._billP = new Promise(res => {
      ...
      s.src = 'data/billing.js?v=9b0b4db0a3';
  ...
  async loadAi() {
    if (!this._aiReady) {
      this._aiReady = import('./js/ai.min.js?v=9516940b4a').then(m => { Object.assign(this, m.aiMembers.call(this)); this.setState({ aiReady: true }); return true; })
