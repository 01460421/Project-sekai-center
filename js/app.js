class Component extends DCLogic {
  ...
  loadBilling() {
    ...
    return (this._billP = new Promise(res => {
      ...
      s.src = 'data/billing.js?v=c9e5f43f3b';
  ...
  async loadAi() {
    if (!this._aiReady) {
      this._aiReady = import('./js/ai.min.js?v=dd2322c9ca').then(m => { Object.assign(this, m.aiMembers.call(this)); this.setState({ aiReady: true }); return true; })
